...
####### Simulation #######
##########################
Sim.Name = 'Examples/HIVE_all_copper'
Sim.Mesh = 'AMAZE' # The mesh used for the simulation
Sim.Materials = {'Block':'Copper', 'Pipe':'Copper', 'Tile':'Copper'}
...
### Aster ###
#############
Sim.AsterFile = 'Monoblock_Steady_nonlinear_solver' # This file must be in Scripts/$SIMULATION/Aster
Sim.Model = '3D'
Sim.Solver = 'MUMPS'
